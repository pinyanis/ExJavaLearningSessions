...
public class HashTableConcept {
	...
	public static void main(String[] args) {
		//it is similar to hashmap, but its is synchornised
		...
		System.out.println("print values from st using enumaration");
		...
		System.out.println("print values from s using entry set");
		Set s = st.entrySet();
		...
		if(st.equals(st1))
			System.out.println("both are equal");  // why is this one is not printing 
